    ...
    <header className="h-[60px] bg-white dark:bg-[#3a3d44] rounded-xl border border-gray-100 dark:border-white/10 flex items-center justify-between px-5 font-poppins shrink-0">
      ...
      <div className="min-w-0">
        ...
        <p className="text-[13px] leading-tight mt-0.5 truncate">
          ...
          <span className="font-semibold text-[#1f1f1f] dark:text-white">{pageTitle}</span>
        </p>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="group flex items-center gap-2.5 hover:bg-gray-50 dark:hover:bg-white/10 rounded-lg py-1 px-1.5 transition-colors duration-200"
          >
            ...
            <div className="text-left hidden lg:block leading-tight">
              <p className="text-[12px] font-medium text-[#1f1f1f] dark:text-white dark:group-hover:text-white">{displayName}</p>
              <p className="text-[10px] text-gray-400 dark:text-gray-300 dark:group-hover:text-gray-200 font-light truncate max-w-[160px]">{displayEmail}</p>
            </div>
            <ChevronDown
              size={12}
          ...
          {menuOpen && (
            <div className="absolute right-0 top-[44px] z-20 bg-white dark:bg-[#3a3d44] border border-gray-100 dark:border-white/10 rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.08)] py-1.5 min-w-[200px]">
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-4 py-2 text-[12.5px] text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
              >
